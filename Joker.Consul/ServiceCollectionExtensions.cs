...
namespace Joker.Consul
{
    ...
    {
        public static void RegisterConsulServices(this IServiceCollection services, Action<ServiceDiscoveryOption> action)
        {
        ...
        private static ConsulClient CreateConsulClient(ServiceDiscoveryOption serviceConfig)
        {
            ...
            {
                config.Address = new Uri(serviceConfig.ConsulUrl);
            });
        }
    }
}