    ...
    internal static class AsyncDispatchProxyGenerator
    {
        ...
        private class ProxyBuilder
        {
            ...
            private void Complete()
            {
                ...
                // chained ctor call
                ConstructorInfo baseCtor = _proxyBaseType.GetTypeInfo().DeclaredConstructors
            ...
            internal void AddInterfaceImpl(Type iface)
            {
                ...
                foreach (PropertyInfo pi in iface.GetRuntimeProperties())
                {
                    ...
                    PropertyBuilder pb = _tb.DefineProperty(pi.Name, pi.Attributes, pi.PropertyType,
            ...
            private MethodBuilder AddMethodImpl(MethodInfo mi)
            {
                ...
                MethodBuilder mdb = _tb.DefineMethod(mi.Name, MethodAttributes.Public | MethodAttributes.Virtual,
                ...
                MethodInfo Type_GetTypeFromHandle =
                    typeof(Type).GetRuntimeMethod("GetTypeFromHandle", new Type[] {typeof(RuntimeTypeHandle)});
                int methodToken;
                Type declaringType;
