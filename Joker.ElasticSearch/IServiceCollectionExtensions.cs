...
public static class ServiceCollectionExtensions
{
        ...
        Action<ElasticSearchOptions> action)
    {
        ...
        if (!string.IsNullOrEmpty(elasticSearchOptions.ConnectionString.Username) &&
            !string.IsNullOrEmpty(elasticSearchOptions.ConnectionString.Password))
            connectionString.BasicAuthentication(elasticSearchOptions.ConnectionString.Username,
                elasticSearchOptions.ConnectionString.Password);
